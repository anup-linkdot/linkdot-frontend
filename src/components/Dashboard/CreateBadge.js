...
const CreateBadge = () => {
  ...
  const createBadgeClick = async () => {
    ...
    if (badge_name === null) setBadgeNameError(true);
    if (badge_description === null) setBadgeDescriptionError(true);
    console.log(
      badge_name_error,
      badge_description,
      badge_desc_error,
    ...
    if (
      badge_name_error === false &&
      badge_desc_error === false &&
      startDate !== null &&
      badge_type !== null &&
      badge_name !== null &&
  ...
  const checkBadgeDescription = (value) => {
    ...
    } else setBadgeDescriptionError(true);
  };
  ...
  return (
    <div className="create-badge-div">
      ...
      <div className="input-row">
        <select
          className="badge-type-select"
          onChange={(e) => getBadgeType(e.target.value)}
        >
          <option className="badge-option" value="" disabled selected>
            Select Badge Type
          </option>
          <option className="badge-option" value="Social Media">
            Social Media
          </option>
          <option className="badge-option" value="Volunteer">
            Volunteer
          </option>
          <option className="badge-option" value="Founding Team">
            Founding Team
          </option>
          <option className="badge-option" value="Design">
            Design
          </option>
          <option className="badge-option" value="Bounty">
            Bounty
          </option>
          <option className="badge-option" value="Partner">
            Partner
          </option>
          <option className="badge-option" value="Community">
            Community
          </option>
          <option className="badge-option" value="Marketing">
            Marketing
          </option>
          <option className="badge-option" value="Sales">
            Sales
          </option>
          <option className="badge-option" value="Artist">
            Artist
          </option>
          <option className="badge-option" value="Speaker">
            Speaker
          </option>
          <option className="badge-option" value="Developer">
            Developer
          </option>
        </select>
      ...
      <div className="input-row">
        <input
          ...
          onChange={(e) => checkBadgeName(e.target.value)}
        />
      ...
      <div className="input-row">
        <textarea
          ...
          onChange={(e) => checkBadgeDescription(e.target.value)}
        ></textarea>
      ...
      <button
        className="badge-input badge-input-file"
        onClick={() => clickInput()}
      >
        <p>{inputFile ? inputFile : "Upload Badge Image"}</p>
      </button>
      <input
        type="file"
        id="getFile"
        onChange={(e) => getInputFile(e.target.files)}
      />
      {loader === false ? (
